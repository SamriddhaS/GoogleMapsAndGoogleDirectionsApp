...
import static com.samriddha.googlemapsandgoogledirectionsapp.Constants.ERROR_DIALOG_REQUEST;
import static com.samriddha.googlemapsandgoogledirectionsapp.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.samriddha.googlemapsandgoogledirectionsapp.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private boolean checkAllRequirementsForMap() {
        /*
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        /*
         * This part can be used to check if the user granted the permissions or not and take
         * action accordingly but we don't need it here as we are check for the permissions inside onResume.
         * */
        switch (requestCode) {
